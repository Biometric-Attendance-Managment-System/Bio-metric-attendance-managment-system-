<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentSignUp.aspx.cs" Inherits="ATMS.Views.Students.StudentSignUp" %>
        ...
        <div class="container p-3">
            <div class="row">
                ...
                <div class="col-md-6 bg-light">
                    <h1 class="font-weight-bolder text-success text-center  m-3">STUDENT REGISTER</h1>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox runat="server" placeholder="Confirm Password" ID="txt_cnfrm_pass" CssClass="form-control" TextMode="Password" />
                    </div>

                    <div class="form-group">

                        <asp:TextBox runat="server" placeholder="Phone" TextMode="Phone" ID="txt_phone" CssClass="form-control" />
                    </div>

                    <div class="form-group">

                        <asp:DropDownList ID="ddl_designations" runat="server" CssClass="form-control"></asp:DropDownList>
                    </div>
                    <div class="form-group">

                        <asp:Label Text="Gender" CssClass=" border-0" runat="server" />
                        <asp:RadioButton Text="Male" CssClass="p-5 " ID="btn_radio_male" runat="server" />
                        <asp:RadioButton CssClass="p-5 " Text="Female" runat="server" ID="btn_radio_female" />
                    </div>
                    <div class="form-group">
