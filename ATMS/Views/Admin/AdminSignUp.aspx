<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSignUp.aspx.cs" Inherits="ATMS.Views.Admin.AdminSignUp" %>
        ...
        <div class="container p-3">
            <div class="row">
                ...
                <div class="col-md-6 bg-light">
                    <h1 class="font-weight-bolder text-success text-center  m-3">ADMIN REGISTER</h1>
                    ...
                    <div class="form-group">
                        ...
                        <asp:Button Text="Submit" CssClass="form-control bg-success text-center text-white font-weight-bold" runat="server" OnClick="btn_submit_Click" />
                    </div>
                     <div class="form-group">
